                ...
                <div class="card shadow">
                    ...
                    <div class="card-header bg-light border-bottom">
                        <ul class="nav nav-tabs nav-fill" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('teacher-payments.index') }}" role="tab">
                    ...
                    <div class="row align-items-center">
                        <div class="col ml-auto">
                            <a href="{{ route('teacher-payments.form') }}" class="btn btn-sm btn-primary mt-3 mr-3">Add New Payment</a>
                        </div>
                    </div>
