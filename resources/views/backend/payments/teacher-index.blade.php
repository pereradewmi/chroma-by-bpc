            ...
            <div class="col">
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="{{ route('teacher-payments.form') }}" class="btn btn-sm btn-primary">Add New Payment</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="px-4 pb-3 d-flex justify-content-end">
                        <form id="teacher-payments-search-form" class="m-2 d-flex align-items-center flex-nowrap justify-content-end" role="search" method="GET" action="{{ route('teacher-payments.index') }}">
