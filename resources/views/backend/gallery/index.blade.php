            ...
            <div class="col">
                <div class="card shadow">
                    ...
                    <div class="px-3 pb-3 d-flex justify-content-end">
                        <form id="gallery-search-form" class="m-2 d-flex align-items-center flex-nowrap justify-content-end" role="search" method="GET" action="{{ route('admin.images.index') }}">
