    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-warning" id="viewLogsBtn" onclick="viewBookingLogs()">
                ...
                <button type="button" class="btn btn-primary" id="editBookingBtn" onclick="editCurrentBooking()">
                ...
                <!-- <button type="button" class="btn btn-danger" id="deleteBookingBtn" onclick="deleteCurrentBooking()">
