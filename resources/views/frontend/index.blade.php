...
@section("title", "Home | Chroma By BPC")
          ...
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
            <div class="program-banner">
              <div class="banner-image">
                <img src="{{ asset('front-assets/img/education/campus-3.webp') }}" alt="Program" class="img-fluid">
              ...
              <div class="row g-3">
                <div class="col-12" data-aos="fade-left" data-aos-delay="200">
                  <div class="program-item">
                    <div class="item-icon">
                      <img src="{{ asset('front-assets/img/education/education-4.webp') }}" alt="Program" class="img-fluid">
                    </div>
                ...
                <div class="col-12" data-aos="fade-left" data-aos-delay="300">
                  <div class="program-item">
                    <div class="item-icon">
                      <img src="{{ asset('front-assets/img/education/education-6.webp') }}" alt="Program" class="img-fluid">
                    </div>
                    <div class="item-content">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-6" data-aos="fade-up" data-aos-delay="100">
            <article class="post-item d-flex">
              <div class="post-img">
                <img src="{{ asset('front-assets/img/blog/blog-post-1.webp') }}" alt="" class="img-fluid" loading="lazy">
              </div>
              ...
              <div class="post-content flex-grow-1">
                ...
                <div class="post-meta">
                  <div class="post-author">
                    <img src="{{ asset('front-assets/img/person/person-f-12.webp') }}" alt="" class="img-fluid">
          ...
          <div class="col-xl-6" data-aos="fade-up" data-aos-delay="200">
            <article class="post-item d-flex">
              <div class="post-img">
                <img src="{{ asset('front-assets/img/blog/blog-post-2.webp') }}" alt="" class="img-fluid" loading="lazy">
              </div>
              ...
              <div class="post-content flex-grow-1">
                ...
                <div class="post-meta">
                  <div class="post-author">
                    <img src="{{ asset('front-assets/img/person/person-f-13.webp') }}" alt="" class="img-fluid">
          ...
          <div class="col-xl-6" data-aos="fade-up" data-aos-delay="300">
            <article class="post-item d-flex">
              <div class="post-img">
                <img src="{{ asset('front-assets/img/blog/blog-post-3.webp') }}" alt="" class="img-fluid" loading="lazy">
              </div>
              ...
              <div class="post-content flex-grow-1">
                ...
                <div class="post-meta">
                  <div class="post-author">
                    <img src="{{ asset('front-assets/img/person/person-m-10.webp') }}" alt="" class="img-fluid">
          ...
          <div class="col-xl-6" data-aos="fade-up" data-aos-delay="400">
            <article class="post-item d-flex">
              <div class="post-img">
                <img src="{{ asset('front-assets/img/blog/blog-post-4.webp') }}" alt="" class="img-fluid" loading="lazy">
              </div>
              ...
              <div class="post-content flex-grow-1">
                ...
                <div class="post-meta">
                  <div class="post-author">
                    <img src="{{ asset('front-assets/img/person/person-f-14.webp') }}" alt="" class="img-fluid">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row g-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="event-item">
              <div class="event-image">
                <img src="{{ asset('front-assets/img/education/events-3.webp') }}" alt="Workshop" class="img-fluid">
          ...
          <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
            <div class="event-item">
              <div class="event-image">
                <img src="{{ asset('front-assets/img/education/events-5.webp') }}" alt="Tournament" class="img-fluid">
                <div class="event-date-overlay">
          ...
          <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="400">
            <div class="event-item">
              <div class="event-image">
                <img src="{{ asset('front-assets/img/education/events-7.webp') }}" alt="Art Exhibition" class="img-fluid">
                <div class="event-date-overlay">
          ...
          <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="event-item">
              <div class="event-image">
                <img src="{{ asset('front-assets/img/education/events-2.webp') }}" alt="Science Fair" class="img-fluid">
                <div class="event-date-overlay">
          ...
          <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
            <div class="event-item">
              <div class="event-image">
                <img src="{{ asset('front-assets/img/education/events-8.webp') }}" alt="Community Event" class="img-fluid">
                <div class="event-date-overlay">
          ...
          <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="400">
            <div class="event-item">
              <div class="event-image">
                <img src="{{ asset('front-assets/img/education/events-6.webp') }}" alt="Music Concert" class="img-fluid">
                <div class="event-date-overlay">
